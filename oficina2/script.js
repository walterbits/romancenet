...
/* =========================================================
   CONTROLE GLOBAL DE ÁUDIO — SEM POLLING
   ========================================================= */
...
/* =========================================================
   INTERSECTION OBSERVER ÚNICO GLOBAL PARA VÍDEOS
   ========================================================= */
...
/* =========================================================
   CARROSSEL — TRANSFORM TRANSLATE3D (GPU) + LOOP INFINITO
   ========================================================= */
...
/* VELOCIDADE DOS CARROSSÉIS — reduzida no mobile */
const CAROUSEL_SPEED = isTouchDevice ? 45 : 75;
